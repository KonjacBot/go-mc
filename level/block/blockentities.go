...
func (PotentSulfurEntity) ID() string          { return "minecraft:potent_sulfur" }
...
func (p PotentSulfurEntity) IsValidBlock(block Block) bool {
	return block.ID() == "minecraft:potent_sulfur"
}
